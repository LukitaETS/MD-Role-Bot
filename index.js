...
if (!token) {
  ...
  const loginTimeout = setTimeout(() => {
    if (!client.isReady()) {
      ...
      estadoDiscord.detalle = 'Discord no confirmo la conexion despues de 20 segundos.';
      estadoDiscord.ultimoError = 'Revisa el token, los intents privilegiados y los logs de Render.';
      console.error('Error: Discord no confirmo la conexion despues de 20 segundos.');
